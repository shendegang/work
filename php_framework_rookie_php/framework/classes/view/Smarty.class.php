...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    */
    public function __construct()
    {
        ...
        // set default dirs
        $this->setTemplateDir(WEBPATH . 'templates/default/'.Rookie_Uri::$modules . DS)
            ->setCompileDir(CACHEPATH . 'caches_templates/default/'.Rookie_Uri::$modules . DS)
            ->setPluginsDir(SMARTY_PLUGINS_DIR)
            ->setCacheDir(WEBPATH . 'cache' . DS)
